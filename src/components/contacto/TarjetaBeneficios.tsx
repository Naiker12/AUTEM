...
export default function TarjetaBeneficios() {
  const whatsappUrl =
    ...
    encodeURIComponent("Hola AUTEM, me interesa recibir información y asesoría sobre sus proyectos en Cartagena y Bolívar.");
    ...
    <div className="flex flex-col justify-between h-full space-y-6">
      <div>
        ...
        <p className="mt-3 text-xs leading-relaxed text-stone-300 font-light">
          Asesoría personalizada de alto nivel para la adquisición de propiedades exclusivas en Cartagena, Barú y Turbaco con gestión fiduciaria y licencias turísticas.
        </p>
      </div>
      ...
      <div className="space-y-3">
        <div className="flex items-start gap-3 rounded-xl border border-white/10 bg-white/5 p-3.5 backdrop-blur-md transition-colors hover:border-accent/40">
          ...
          <div>
            ...
            <p className="text-[11px] text-stone-400">Un consultor especializado te contactará personalmente.</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-3 rounded-xl border border-white/10 bg-white/5 p-3.5 backdrop-blur-md transition-colors hover:border-accent/40">
          ...
          <div>
            ...
            <p className="text-[11px] text-stone-400">Tratamiento privado de información para inversionistas.</p>
          </div>
        </div>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="block text-xs font-bold uppercase tracking-wider">Atención VIP por WhatsApp</span>
              <span className="text-[10px] text-emerald-300/80">Asesor disponible ahora en línea</span>
            </div>
          </div>
